...
export default function App() {
    ...
    return (_jsxs("div", { style: { display: "grid", placeItems: "center", height: "100%" }, children: [_jsxs("div", { style: { display: "flex", gap: 12, marginBottom: 8 }, children: [_jsx("button", { onClick: () => setRunning((r) => !r), style: btnStyle, "aria-label": "Pause or resume", children: running ? "Pause" : "Resume" }), _jsx("button", { onClick: restart, style: btnStyle, "aria-label": "Restart", children: "Restart" })] }), _jsx("canvas", { ref: canvasRef, width: CANVAS_W, height: CANVAS_H, style: {
                    width: CANVAS_W,
                    height: CANVAS_H,
                    borderRadius: 12,
                    ...
                    background: "#071025"
                } }), _jsx("p", { style: { color: "#9fd6ff", marginTop: 8 }, children: "Tip: Tap left/right sides to switch lanes. Press R to restart, P to pause." })] }));
}
const btnStyle = {
